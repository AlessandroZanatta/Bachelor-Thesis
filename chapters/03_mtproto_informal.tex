...
A successful protocol run consists of three rounds:
\begin{description}
...
%% UPDATE: It actually (kinda) does: it's encrypted as a cloud-chat message! For simplicity, keep this notation and explain it's meaning in the written part.
